<template>
  <section class="loginContainer">
    <div class="loginInner">
      ...
      <a href="javascript:" class="go_back" @click="backclick">
...
import { reqSendcode, reqSenLogin, reqPwdLogin } from "../../api";
...
export default {
  ...
  data() {
    return {
      loginWay: true, // 登录方式 true 短信登录 false 密码登录
      phone: "", // 手机号码
  ...
  methods: {
    ...
    async login() {
      ...
      if (this.loginWay) {
        ...
        // 发送短信登录请求
        result = await reqSenLogin(phone, code);
      } else {
        //密码登录
